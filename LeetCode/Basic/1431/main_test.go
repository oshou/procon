...
func Test_kidsWithCandies(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "case1",
			args: args{candies: []int{2, 3, 5, 1, 3}, extraCandies: 3},
			want: []bool{true, true, true, false, true},
		},
		{
			name: "case2",
			args: args{candies: []int{4, 2, 1, 1, 2}, extraCandies: 1},
			want: []bool{true, false, false, false, false},
		},
		{
			name: "case3",
			args: args{candies: []int{12, 1, 12}, extraCandies: 10},
			want: []bool{true, false, true},
		},
		{
			name: "caser4",
			args: args{candies: []int{2, 8, 7}, extraCandies: 1},
